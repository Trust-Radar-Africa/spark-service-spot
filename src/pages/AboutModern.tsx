              ...
              {approach.map((item, index) => (
                <AnimatedSection key={item.title} delay={index * 100}>
                  <div className="flex items-start gap-4 p-5 rounded-xl bg-qx-light-gray">
                    ...
                    <div>
                      <h3 className="text-base font-montserrat font-bold text-qx-blue mb-1">{item.title}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <AnimatedSection animation="slide-left">
              <div>
                ...
                <p className="text-qx-gray mb-4 leading-relaxed text-sm md:text-base">
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-qx-light-gray border border-gray-100">
                  ...
                  <div>
                    <div className="font-bold text-qx-blue text-sm">IFAC Affiliate Member</div>
                    <div className="text-xs text-qx-gray">Bound by international ethics and professional standards</div>
                  </div>
                </div>
              </div>
            </AnimatedSection>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-10">
              <h2 className="text-2xl md:text-3xl font-montserrat font-bold text-qx-blue mb-3">
                Why Outsource to Multiverse CPA?
              </h2>
              <p className="text-qx-gray text-sm md:text-base">
            ...
            {benefits.map((benefit, index) => (
              <AnimatedSection key={index} delay={index * 50}>
                <div className="flex items-start gap-3 p-4 rounded-xl bg-white border border-gray-100">
                  ...
                  <span className="text-qx-blue text-sm">{benefit}</span>
                </div>
              </AnimatedSection>
            ))}
          </div>
            ...
            {values.map((value, index) => (
              <AnimatedSection key={value.title} delay={index * 100}>
                <div className="text-center p-6 rounded-xl bg-qx-light-gray border border-gray-100 hover:shadow-lg hover:border-qx-orange/20 transition-all duration-300 h-full">
                  ...
                  <h3 className="text-base font-montserrat font-bold text-qx-blue mb-2">
                    {value.title}
                  </h3>
