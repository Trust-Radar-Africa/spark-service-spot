          ...
          <div className="grid lg:grid-cols-12 gap-12 max-w-6xl mx-auto">
            ...
            <aside className="lg:col-span-4">
              ...
              <div className="bg-card rounded-xl p-6 shadow-card mb-8">
                <h3 className="font-serif text-lg font-bold text-foreground mb-4">About the Author</h3>
              ...
              <div className="bg-gradient-navy rounded-xl p-6 mb-8">
                <h3 className="font-serif text-lg font-bold text-primary-foreground mb-2">Stay Updated</h3>
