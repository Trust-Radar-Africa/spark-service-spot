        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
            {stats.map((stat, index) => (
              <div 
                key={stat.label} 
                className="hover-lift glass-card rounded-xl p-4 md:p-5 text-center group"
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            {whyChoose.map((item, index) => (
              <div
                key={item.title}
                className="group bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-5 border border-white/10 hover:bg-white/20 hover:border-qx-orange/30 transition-all duration-300 hover:-translate-y-1"
                style={{ animationDelay: `${index * 100}ms` }}
              >
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-6">
            {services.map((service, index) => (
              <Link
                key={service.title}
                to={service.href}
                className="group relative bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
                style={{ animationDelay: `${index * 100}ms` }}
              >
